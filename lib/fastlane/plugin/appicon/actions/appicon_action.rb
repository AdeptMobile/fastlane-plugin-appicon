      ...
      def self.needed_icons
        {
          ...
          iphone: {
            '2x' => ['20x20', '29x29', '40x40', '60x60', '120x120'],
            '3x' => ['20x20', '29x29', '40x40', '60x60', '120x120']
          },
          ipad: {
            '1x' => ['20x20', '29x29', '40x40', '76x76', '167x167', '152x152'],
            '2x' => ['20x20', '29x29', '40x40', '76x76', '83.5x83.5', '167x167', '152x152']
          },
          :ios_marketing => {
            '1x' => ['1024x1024']
          },
